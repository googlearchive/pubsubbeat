...
"""
Tests for the Redis's send_request and send_response
options.
"""
...
class Test(BaseTest):
    ...
    def test_default_settings(self):
        ...
        self.run_packetbeat(pcap="redis_one_transaction.pcap")
    ...
    def run_with_options(self, send_request, send_response):
        self.render_config_template(
            redis_ports=[6380],
            redis_send_request=send_request,
            redis_send_response=send_response,
        )
        self.run_packetbeat(pcap="redis_one_transaction.pcap")
